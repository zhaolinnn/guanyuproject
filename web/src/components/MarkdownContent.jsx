...
/**
 * Renders markdown as React with consistent styling for assignment pages.
 * Use with: import content from './MyContent.md?raw' then <MarkdownContent>{content}</MarkdownContent>
 */
